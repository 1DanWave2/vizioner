...
PAGES = [
    ...
    },
    {
        ...
        "description": "Каталог 49 работ современных российских художников: пейзажи, натюрморты, абстракция. Фильтр по типу, художнику. Цены от 55 000 ₽.",
        "type": "website",
        "priority": "0.9",
    },
    {
        ...
        "description": "Изумрудов, Углач, Шугаев, Есенов — современные российские живописцы. Биографии, темы работ, текущая коллекция в галерее.",
        "type": "website",
        "priority": "0.9",
    },
    {
